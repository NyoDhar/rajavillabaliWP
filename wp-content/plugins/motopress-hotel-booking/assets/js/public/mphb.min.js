...
MPHB.CheckoutForm = can.Control.extend( {
	...
	updateCheckoutInfo: function() {
		...
		self.showPreloader();
		//BLK edit
		$('#mphb-price-details').addLoadingLayer();
		...
		this.updateInfoTimeout = setTimeout( function() {
			...
			self.currentInfoAjax = $.ajax( {
				...
				complete: function( jqXHR ) {
					...
					//BLK edit
					$('#mphb-price-details').removeLoadingLayer();
				}
			} );
		}, 500 );
	},
	...
	'.mphb_checkout-service, .mphb_checkout-service-adults change': function( el, e ) {
		//console.log(el);
		//BLK edit
		if(el.hasClass('mphb_checkout-service')){
			if(el.is(':checked')){
				el.parent().next('.service-request-detail').slideDown();
			}else{
				el.parent().next('.service-request-detail').slideUp();
			}
		}
		this.updateCheckoutInfo();
	},
