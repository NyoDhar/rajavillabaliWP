...
class ReportsMenuPage extends AbstractMenuPage
{
    ...
    protected function renderBookingsTab()
    {
        ...
        echo '<div class="metabox-holder">';
            $this->renderExportBookingsForm();
        echo '</div>';
    }

    protected function renderExportBookingsForm()
    {
        ...
        <div class="postbox mphb-export-bookings-report">
            ...
            <div class="inside">
                <form id="mphb-export-bookings-form" class="mphb-export-form" method="POST">
                    ...
                    <p>
                        <button class="submit-button button button-secondary"><?php _e('Generate CSV', 'motopress-hotel-booking'); ?></button>
