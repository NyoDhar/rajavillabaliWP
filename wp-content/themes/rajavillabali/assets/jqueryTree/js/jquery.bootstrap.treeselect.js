(function ($) {
    ...
    $.fn.treeselect = function (options) {
		...
		$button.data('text', settings.buttontext);
		$button.data('selectedtotal', settings.selectedTotal);
        ...
        function updateButtonText() {
            ...
            if (buttontext.length > 0) {
                if (buttontext.length <= $button.data('selectedtotal')) {
                ...
                $button.children('span').text($button.data('text'));
            }
        }
    };
}(jQuery));